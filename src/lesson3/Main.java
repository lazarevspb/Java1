...
//            printMap();
    ...
    private static void aiTurn() {
        ...
        byte divider = (WIN_POINT == 3) ? 0b011 : 0b111;
...
//        byte divider = (WIN_POINT == 3) ? 0b011 : 0b111;
        ...
        for (int i = 0; i < square.length; i++) {
            ...
            System.out.println(Integer.toBinaryString(arrayAIbyte[1]));
...
//                System.out.println(Integer.toBinaryString(arrayAIbyte[6]));
                ...
                for (int k = 0; k < arrayAIbyte.length; k++) {
                    if (arrayAIbyte[k] % divider == 0 && arrayAIbyte[k] != 0) {
                        ...
                        if (arrayAIbyte[k] == arrayAIbyte[1]) {

                            if ((validation(i + 1, square.length - i - 2) &&
                                    isEmpty(i + 1, square.length - i - 2))) {                                 //ПД
                                square[i + 1][square.length - i - 2] = DOT_O;
                                System.out.println("ПД1");

                                return true;
                            }
                            else if ((validation(square.length  - i, i-1)) && isEmpty(square.length  - i, i-1) && arrayAIbyte[k] == 0b11100) {
                                square[square.length  - i][i-1] = DOT_O;

                                System.out.println("ПД2");

                                return true;
                            }
                            else if ((validation(square.length  - i-1, i)) && isEmpty(square.length  - i-1, i)) {
            ...
            for (int l = 6; l < arrayAIbyte.length; l++) {
                arrayAIbyte[l] = (byte) 0;
            }
